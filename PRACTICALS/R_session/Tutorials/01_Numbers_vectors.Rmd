...
There are many other functions that we can use, but we will either see them in the next tutorials or you will find them when working with your own data :smile: 
Now it is time for some more exercises!

## 3. Exercises 

Before getting started with the exercises for this tutorial, please make sure that you have checked the following built-in functions and you understand how to use them. Otherwise, ask us for help! :smile:
